...
However, we also do not want to treat heavy reviewers as same as inactive users, because these few heavy users creates bigger
...
This sampling method resulted in the sample with 100 items and 2,916 users by incorporating the distribution ofthe level of activities of users and the distribution of popularity and category of items.
